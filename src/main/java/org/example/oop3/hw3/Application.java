...
public class Application {
    ...
    void startGame() {
        ...
        System.out.println("Вам доступны варианты: 1 - угадывание числа, " +
                "2 - угадывание букв (АНГ.), 3 - угадывание букв (РУС.)");
        ...
        } else if (game.getGameStatus().equals(GameStatus.FINISH)) {
